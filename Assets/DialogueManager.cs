...
public class DialogueManager : MonoBehaviour
{
    ...
    public List<string[]> diags = new List<string[]>{
        ...
        new string[]{"Hello there.","My girlfriend hates me for being too ordinary.",
        "So I promised her a perfect date.",
        "Can you transform my body so I can be someone special?",
        "By the way, she has many suitors. Give me a weapon that can drive away those nasty guys!"},
        new string[]{"Hi. I am doing delivery.",
        "Normally, I need to travel miles to break through countless obstacles and deliver food to people.",
        "This is the glory of our deliveryman.",
        "But someone called for a takeaway on NYU's lecture and asked me to enter lightly.",
        "This is stumping me! I'm a brave soldier, and the only thing I can't do is to be light-footed. ",
        "Can you help me?"},
        new string[]{"I am a game developer. And here comes TGA 2020! ",
        "I don't want to be a human being anymore! ",
        "I decided to abandon this human body because human beings have limits. ",
        "Only by pushing the limits can you develop the best game!",
